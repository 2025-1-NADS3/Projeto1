...
public class CanteenReceiptActivity extends AppCompatActivity {
    ...
    private TextView txtStatus, txtValor, txtSenhaPedido;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_canteen_receipt);
        ...
        txtSenhaPedido = findViewById(R.id.txtSenhaPedido);
    ...
    private File gerarComprovantePDF(ArrayList<String> itens, String chavePix, String data) {
        ...
        y += 20;
        canvas.drawText("Senha do Pedido: " + senhaPedido, 50, y, paint);
        y += 30;
