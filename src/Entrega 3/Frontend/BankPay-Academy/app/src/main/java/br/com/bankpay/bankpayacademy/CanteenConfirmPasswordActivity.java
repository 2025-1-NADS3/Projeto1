...
public class CanteenConfirmPasswordActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_canteen_confirm_password);
        ...
        btnConfirmarPagamento.setOnClickListener(v -> {
            ...
            confirmarPagamentoCantina(chave_pix, senha, itensIds);
        });

    }

    // Função para enviar uma requisição POST para a rota /cantina/pagarCantina, confirmando o pagamento
    private void confirmarPagamentoCantina(String chavePix, String senha, ArrayList<Integer> itensIds) {
        //String url = "http://10.0.2.2:3000/cantina/pagarCantina";
        String url = "https://plyhcd-3000.csb.app/cantina/pagarCantina";
        ...
        JsonObjectRequest request = new JsonObjectRequest(Request.Method.POST, url, json,
                response -> {
                    try {
                        ...
                        Intent intent = new Intent(CanteenConfirmPasswordActivity.this, CanteenReceiptActivity.class);
